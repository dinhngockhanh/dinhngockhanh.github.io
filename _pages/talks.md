...
<tr style="border-bottom: 1px solid transparent;">
    ...
    <td class="col-desc" style="padding-bottom: 1rem;">
        <em>BIOT conference - biotechnology and bioinformatics symposium</em><br/>
        <strong>A case study of solving the Chemical Master Equation with time-varying parameters</strong>; Khanh N. Dinh
    </td>
</tr>
<tr style="border-bottom: 1px solid transparent;">
    <td class="col-year" style="vertical-align: top; padding-bottom: 1rem; width: 130px;">
